...
class _HomeNewsWidgetState extends State<HomeNewsWidget> {
  ...
  final List<News> newsItems = [
    News(
      ...
      content: '''Một chế độ dinh dưỡng hợp lý đầy đủ các nhóm chất là chìa khóa để duy trì một hệ miễn dịch khỏe mạnh. Bạn nên tập trung vào các loại thực phẩm giàu Vitamin C như cam, chanh, bưởi, và các loại rau xanh.
...
Các chuyên gia khuyên rằng bạn nên đa dạng hóa thực đơn hằng ngày để đảm bảo cung cấp đủ các vi chất cần thiết như Kẽm, Sắt và Vitamin D.''',
    ...
    News(
      ...
      content: '''Trong cuộc sống hiện đại đầy áp lực, Yoga là một phương pháp tuyệt vời để tìm lại sự cân bằng. Dưới đây là 5 tư thế đơn giản bạn có thể thực hiện ngay tại nhà:
...
Chỉ cần dành ra 15-20 phút mỗi ngày, bạn sẽ thấy tinh thần sảng khoái và giảm bớt các cơn đau mỏi vai gáy do ngồi làm việc quá lâu.''',
    ...
    News(
      ...
      content: '''Kiểm tra sức khỏe định kỳ không chỉ là việc đi khám khi có bệnh mà là một thói quen văn minh để bảo vệ bản thân. 
