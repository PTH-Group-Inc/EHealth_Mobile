...
class _EditMedicalRecordScreenState extends State<EditMedicalRecordScreen> {
  ...
  void _onSave() {
    final request = UpdatePatientRequest(
      ...
      id_card_number: _idCardController.text,
    ...
    return BlocListener<EditMedicalRecordCubit, EditMedicalRecordState>(
      listener: (context, state) {
        if (state is EditMedicalRecordSuccess) {
          ...
          // Pop twice to return to list screen or pop once and update detail?
          // Let's pop with the updated patient so detail screen can update if it listens, 
          // or just pop and let the list refresh.
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildTextField(_idCardController, "Nhập số định danh"),
              const SizedBox(height: 16),
              
              _buildInputLabel("Địa chỉ"),
              _buildTextField(_addressController, "Nhập địa chỉ cụ thể", maxLines: 2),
              const SizedBox(height: 16),
              ...
              _buildTextField(_emergencyNameController, "Nhập tên người liên hệ"),
              const SizedBox(height: 16),
              
              _buildInputLabel("SĐT người liên hệ"),
              _buildTextField(_emergencyPhoneController, "Nhập SĐT người liên hệ", keyboardType: TextInputType.phone),
