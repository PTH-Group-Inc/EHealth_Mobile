...
FacilityServiceResponse _$FacilityServiceResponseFromJson(
  ...
  basePrice: FacilityServiceResponse._parsePrice(json['base_price']),
  insurancePrice: FacilityServiceResponse._parsePriceNullable(
    json['insurance_price'],
  ),
  vipPrice: FacilityServiceResponse._parsePriceNullable(json['vip_price']),
